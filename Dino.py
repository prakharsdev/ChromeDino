...
def gameloop():
    ...
    while True:
        ...
        cactus1 = pygame.transform.scale(cactus1, (60, 50))
        cactus2 = pygame.image.load("cactusSmallMany0000.png")
        cactus2 = pygame.transform.scale(cactus2, (200, 100))
        dino = pygame.image.load("dinorun0000.png")
        dino1 = pygame.image.load("dinorun0001.png")

        walk = [dino, dino1, dino, dino1]
        background = pygame.image.load("un.png")
        ...
        if drawy < 440:
            if jump == False:
                drawy +=gravity
        if cactusx < drawx + 50 < cactusx +200 and cactusy < drawy + 50 < cactusy + 50 :
            backvelocity = 0
            walkpoint = 0
            game = False
            gameover = True
        ...
        screen.blit(background, [backx + 760,backy])
        ...
        screen.blit(cactus2, [cactusx + 1200,cactusy - 8])
